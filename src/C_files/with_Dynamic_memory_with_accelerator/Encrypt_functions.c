...
enum status mixColumns(unsigned char state[][STATE_ROWS_NUMBER],unsigned char mixed[][STATE_COLUMNS_NUMBER])
{
    ...
    {
        unsigned char temp_mul2, temp_mul3;//status = R_Boxes(state[0][i], &temp_mul2, mul2);
        //status = R_Boxes(state[1][i], &temp_mul3, mul3);

        Xil_Out32(XPAR_R_BOXES_IP_V1_0_0_BASEADDR + 4*0, (u32)state[0][i] );
		Xil_Out32(XPAR_R_BOXES_IP_V1_0_0_BASEADDR + 4*1, mul2 );
		temp_mul2 = Xil_In32(XPAR_R_BOXES_IP_V1_0_0_BASEADDR + 4*2);

		Xil_Out32(XPAR_R_BOXES_IP_V1_0_0_BASEADDR + 4*0, (u32)state[1][i] );
		Xil_Out32(XPAR_R_BOXES_IP_V1_0_0_BASEADDR + 4*1, mul3 );
		temp_mul3 = Xil_In32(XPAR_R_BOXES_IP_V1_0_0_BASEADDR + 4*2);
		...
		Xil_Out32(XPAR_R_BOXES_IP_V1_0_0_BASEADDR + 4*0, (u32)state[2][i] );
		Xil_Out32(XPAR_R_BOXES_IP_V1_0_0_BASEADDR + 4*1, mul3 );
		temp_mul3 = Xil_In32(XPAR_R_BOXES_IP_V1_0_0_BASEADDR + 4*2);
		...
		Xil_Out32(XPAR_R_BOXES_IP_V1_0_0_BASEADDR + 4*0, (u32)state[3][i] );
		Xil_Out32(XPAR_R_BOXES_IP_V1_0_0_BASEADDR + 4*1, mul3 );
		temp_mul3 = Xil_In32(XPAR_R_BOXES_IP_V1_0_0_BASEADDR + 4*2);
...
enum status SubShiftRow(unsigned char state[][STATE_ROWS_NUMBER], unsigned char result[][STATE_COLUMNS_NUMBER])
{
    ...
    Xil_Out32(XPAR_R_BOXES_IP_V1_0_0_BASEADDR + 4*1, sub );
